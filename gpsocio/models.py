...
class GPSocioConfig(LongformerConfig):
...
@dataclass
class GPSocioPretrainingOutput:
...
class GPSocioEmbeddings(nn.Module):
    """
    Same as BertEmbeddings with a tiny tweak for positional embeddings indexing.
    """

    def __init__(self, config: GPSocioConfig):
        super().__init__()
        ...
        self.influence_position_embeddings = nn.Embedding(config.max_item_embeddings, config.hidden_size)
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, item_position_ids=None, influence_position_ids=None, inputs_embeds=None):
        ...
        influence_position_embeddings = self.influence_position_embeddings(influence_position_ids)
...
class GPSocioModel(LongformerPreTrainedModel):
    def __init__(self, config: GPSocioConfig):
        ...
        self.embeddings = GPSocioEmbeddings(config)
        self.encoder = LongformerEncoder(config)
        self.pooler = GPSocioPooler(config)
    ...
    def _pad_to_window_size(
        ...
        influence_position_ids: torch.Tensor,
        ...
        if padding_len > 0:
            ...
            if influence_position_ids is not None:
                influence_position_ids = nn.functional.pad(influence_position_ids, (0, padding_len), value=pad_token_id)
        ...
        return padding_len, input_ids, attention_mask, token_type_ids, position_ids, item_position_ids, influence_position_ids, inputs_embeds
    ...
    def forward(
        ...
        influence_position_ids: Optional[torch.Tensor] = None,
        ...
        padding_len, input_ids, attention_mask, token_type_ids, position_ids, item_position_ids, influence_position_ids, inputs_embeds = self._pad_to_window_size(
            input_ids=input_ids,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
            position_ids=position_ids,
            item_position_ids=item_position_ids,
            influence_position_ids = influence_position_ids,
        ...
        embedding_output = self.embeddings(
            input_ids=input_ids, position_ids=position_ids, item_position_ids=item_position_ids, influence_position_ids = influence_position_ids, token_type_ids=token_type_ids, inputs_embeds=inputs_embeds
        )
...
class GPSocioForPretraining(LongformerPreTrainedModel):
    def __init__(self, config: GPSocioConfig):
        super().__init__(config)

        self.longformer = GPSocioModel(config)
    ...
    def forward(
        ...
        influence_position_ids_a: Optional[torch.Tensor] = None,
        ...
        influence_position_ids_b: Optional[torch.Tensor] = None,
        ...
        # print("input_ids_ainput_ids_a",input_ids_a.shape)
        # print("input_ids_binput_ids_b",input_ids_b.shape)
        ...
        outputs_a = self.longformer(
            ...
            influence_position_ids = influence_position_ids_a,
            inputs_embeds=inputs_embeds,
            output_attentions=output_attentions,
            output_hidden_states=output_hidden_states,
            return_dict=True,
        ...
        outputs_b = self.longformer(
            ...
            influence_position_ids = influence_position_ids_b,
            inputs_embeds=inputs_embeds,
            output_attentions=output_attentions,
            output_hidden_states=output_hidden_states,
            return_dict=True,
        ...
        # print("torch.argmax(cos_sim, 1)",torch.argmax(cos_sim, 1))

        # if mlm_outputs_a is not None and mlm_labels_a is not None:
        #     # print("mlm_input_ids_a",mlm_input_ids_a)
        ...
        #     # print("prediction_scores_a",prediction_scores_a.view(-1, self.config.vocab_size))
        #     # print("masked_lm_loss_a",mlm_labels_a.view(-1))
        ...
        #     # print("prediction_scores_bprediction_scores_b",prediction_scores_b)
        ...
        return GPSocioPretrainingOutput(
            loss=loss,
            logits=cos_sim,
...
class GPSocioForSeqRec(LongformerPreTrainedModel):
    def __init__(self, config: GPSocioConfig):
        super().__init__(config)
    ...
    def forward(self,
        ...
        if labels is None:
            return self.similarity_score(pooler_output, candidates), pooler_output
